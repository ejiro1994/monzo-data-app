      ...
      <div>
        <Wrapper>
          <div className='inline-block min-w-full shadow-md rounded-lg overflow-hidden'>
            <TableWrapper className='min-w-full leading-normal'>
              <TableHeader>
                <TableRow>
                  <TableHeader className='px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider'>
                    Client / Invoice
                  </TableHeader>
                  <TableHeader className='px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider'>
                    Amount
                  ...
                  <TableHeader className='px-5 py-3 border-b-2 border-gray-200 bg-gray-100'></TableHeader>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow>
